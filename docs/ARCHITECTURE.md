# Arquitetura — Ledger privado transfronteiriço (Hyperledger Fabric)

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Canais privados, chaincode de registro e políticas de endosso.
...
|------------|------------------|
| Chaincode | Chaincode invoice |
| Canais | Canais privados |
| Scripts | Scripts bootstrap |
| Políticas | Políticas de endosso |
| Imutabilidade | Imutabilidade auditável |
