# Cross-Border Private Ledger (Hyperledger Fabric)
...
> **Blockchain permissionada para faturas internacionais.**

Desenvolvido e mantido por [@SrSatriano](https://github.com/SrSatriano). Repositório: [cross-border-ledger-fabric](https://github.com/SrSatriano/cross-border-ledger-fabric).
...
- [x] Chaincode invoice register
- [x] Canais privados multi-org
- [x] Políticas de endosso
- [x] Bootstrap B2B scripts
