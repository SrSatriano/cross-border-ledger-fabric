...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [cross-border-ledger-fabric](https://github.com/SrSatriano/cross-border-ledger-fabric).
