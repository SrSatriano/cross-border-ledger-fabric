# Guia de deploy — Ledger privado transfronteiriço (Hyperledger Fabric)

> Versão **1.0.0** · Stack: **Hyperledger Fabric, Go chaincode, Docker**
...
3. Execute `./network/scripts/test_chaincode.sh` ou smoke tests automatizados.
